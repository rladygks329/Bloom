		  ...
		  <ul class="pagination justify-content-center" >
		  	<c:if test="${not empty keyword}">
		  		<li class="page-item  ${pageMaker.hasPrev ? "" : "disabled"}">
					<a class="page-link" href="list?page=${pageMaker.startPageNo - 1 }&keyword=${keyword}" tabindex="-1">Previous</a>
				</li>
				<c:forEach var="i" begin="${pageMaker.startPageNo}" end="${pageMaker.endPageNo}">
			  	...
			  	<li class="page-item ${pageMaker.hasNext ? "" : "disabled"}">
			  		<a class="page-link" href="list?page=${pageMaker.endPageNo + 1 }&keyword=${keyword}" tabindex="-1">Next</a>
				</li>
		  	</c:if>
		  	<c:if test="${empty keyword}">
			  	<li class="page-item  ${pageMaker.hasPrev ? "" : "disabled"}">
					<a class="page-link" href="list?page=${pageMaker.startPageNo - 1 }" tabindex="-1">Previous</a>
				</li>
				<c:forEach var="i" begin="${pageMaker.startPageNo}" end="${pageMaker.endPageNo}">
					<li class="page-item ${pageMaker.criteria.page == i ? "active" : " "}">
			  	...
			  	<li class="page-item ${pageMaker.hasNext ? "" : "disabled"}">
			  		<a class="page-link" href="list?page=${pageMaker.endPageNo + 1 }" tabindex="-1">Next</a>
				</li>
		  	</c:if>
		  </ul>
		</nav>
