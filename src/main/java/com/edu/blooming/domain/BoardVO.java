...
public class BoardVO {
	...
	public BoardVO(int boardId, int memberId, int boardParentId, String boardTitle, String boardContent,
			int boardViewCount, int boardAnswerCount, int boardReplyCount, int boardLikeCount, Date boardDateCreated) {
		super();
	...
	public String toString() {
		return "BoardVO [boardId=" + boardId + ", memberId=" + memberId + ", boardParentId=" + boardParentId
